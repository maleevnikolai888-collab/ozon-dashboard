...
st.title("📊 Юнит-экономика: Логистика и ОСНО")
        ...
        if res.status_code == 200:
            ...
            if res_details.status_code == 200:
                ...
                if final_data:
                    ...
                    st.success(f"Рассчитано товаров: {len(df)}")
